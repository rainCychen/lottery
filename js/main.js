...
(function () {
  ...
  var createHTML = function () {
    ...
    member.forEach(function (item, index) {
      ...
      html.push(
        '<li ><a class="aname" href="#" style="color:' +
          color +
  ...
  var lottery = function (count) {
    ...
    var color =
      "#" + ("00000" + Math.floor(Math.random() * 0xffffff)).slice(-6);
    var color = "yellow";
    if (remain <= count) {
      for (var i in member) {
        key = getKey(member[i]);
  ...
  new Vue({
    ...
    ready: function () {
      ...
      TagCanvas.Start("myCanvas", "tags", {
        ...
        txtOpt: true,
        textColour: "",
        tooltipDelay: "300" /* outlineMethod: 'colour', */,
        outlineColour: "rgb(212, 235, 10)",
        outlineOffset: 5,
        depth: 0.8,
        minBrightness: 0.3,
        wheelZoom: true,
        ...
        imageVAlign: "middle",
        imageScale: 0.5,
        // /* centreFunc: RSquare, */ centreImage: "./img/title.png",
      });
    },
    methods: {
      reset: function () {
        ...
        if (this.running) {
          ...
          $("#result")
            ...
            .html(
              '<div><img src="' +
                ret[0] +
                '" style="height:380px;"/><br><span>&nbsp;&nbsp;恭喜<i style="font-size: 35px;color: yellow;margin: 10px;">' +
                ret[1] +
                "</i>中奖啦！&nbsp;</span></div>"
